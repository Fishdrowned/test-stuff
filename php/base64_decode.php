...
function base62RevEncode($value, $space = 1e9)
{
    return base62encode(strrev($value * 10 + $space + mt_rand(1, 9)));
}

function base62RevDecode($value, $space = 1e9)
{
    return (int)((strrev(base62decode($value)) - $space) / 10);
}
...
<form method="post" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>">
    ...
    <p>
        ...
        <button type="submit" name="type" value="base62RevEncode">base62RevEncode</button>
        <button type="submit" name="type" value="base62RevDecode">base62RevDecode</button>
    </p>
</form>
<div>
    <label>Result:<br/><textarea cols="200"
            rows="20"><?php echo strlen($code) ? $func($code) : ''; ?></textarea></label>
</div>
</body>
</html>
